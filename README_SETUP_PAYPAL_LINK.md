# HOST OS 1.3.0 — Checkout PayPal Link + Bonifico
...
2. HOST OS crea un ordine univoco HOS-... nel database.
...
8. HOST OS marca l'ordine PAGATO, genera il link protetto, invia l'e-mail e porta l'ordine a CONSEGNATO se l'invio riesce.
